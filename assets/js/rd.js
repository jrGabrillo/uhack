...
account = {
    ...
    get: function() {
        var data = system.html('../assets/harmony/Process.php?get-accountRD');
        return data.responseText;
    },
    id: function() {
        let data = JSON.parse(this.get());
...
relationshipManager = {
    ...
    list:function(){
        let branch_id = JSON.parse(account.get());
        var data = system.ajax('../assets/harmony/Process.php?get-listAccountRMByRD',branch_id[0][15]);
        data.done(function(data){
